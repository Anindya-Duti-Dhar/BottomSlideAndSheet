...
public class SlidingUpFromBottom extends Fragment {
    ...
    public static SlidingUpFromBottom newInstance() {
        SlidingUpFromBottom fragment = new SlidingUpFromBottom();
        fragment.setRetainInstance(true);
        return fragment;
    }


    public SlidingUpFromBottom() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.sliding_up_from_bottom, container, false);
    }
